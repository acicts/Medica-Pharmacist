...
import { Button, PageButton } from '../Context/Button'
    ...
    const columns = useMemo(() => [
        ...
        },
        {
            ...
            Cell: (props:any) => (
                ...
                <button
                        type="button"
                        className="text-white bg-[#00a57c] hover:bg-[#40a321] focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center mr-2">
                    <AiOutlineEdit />
