        ...
        />} */}
				{uploading ? (
					...
					<>
						...
						<img src={MessageSent} alt="verified-succesfully" />
						<div>
							<p className="font-light text-[#6C6C6C] text-center">
								No email recieved?
							</p>
							<p className="font-light text-[#6C6C6C] text-center">
								Please check the spam folder or re-check the
					...
					<>
						...
						<form
							className="lg:w-[50%] md:w-[70%] w-[90%]"
						...
						>
							<Field
								...
								label="Email"
							/>
							<button className="register-btn-2 w-full">
								Submit
							</button>
						</form>
