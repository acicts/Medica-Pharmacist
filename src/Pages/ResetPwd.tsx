...
const Form = () => {
  ...
  const pwd1Validator = useInput(
    (inputVal) => inputVal.length >= 6
  );
      ...
      >
        <div>
          <Field
            ...
            ref={pwd1Validator.inputRef as RefObject<HTMLInputElement>}
            id='pwd1'
            type='password'
          ...
          <Field
            ...
            ref={pwd2Validator.inputRef as RefObject<HTMLInputElement>}
            id='pwd2'
            type='password'
